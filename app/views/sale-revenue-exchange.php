...
$shops = $_SALEREVENUE->getAllShop(); // Lấy thông tin của tất cả các shop
$index = 0;
foreach ($shops as $shop) {
	$products = $_SALEREVENUE->getProductByShopId($shop['id']); // Lấy thông tin của sản phẩm theo từng shop
