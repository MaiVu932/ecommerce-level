					...
					<div class="shop-menu clearfix pull-right">
						<ul class="nav navbar-nav">
							...
							<?php if (isset($_SESSION['username'])) : ?>
								...
								<li><a href="notification_list.php"><i class="fa fa-bell"></i> Notification
										<?php
										include_once '../Repositories/ComplainRepository.php';
										$__COMPLAIN = new ComplainRepository;
										$countNotification = $__COMPLAIN->countNotification($_SESSION['id']);
										if ($countNotification)
											echo '<b style="color: red">(' . $countNotification . ')</b>';
										?>
