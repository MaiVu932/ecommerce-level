...
if ($user['permission'] >= 2)
	$shop = $_SHOP->getShopById($id); // Lấy thông tin của shop theo id
else
	$shop = $_SHOP->getShopByIdAndUserId($id, $user['id']); // Lấy thông tin của shop của người dùng
...
<section id="salerevenue">
	<div class="container">
		...
		<?php else : ?>
			<h2 class="title text-center">Doanh số - Doanh thu của shop theo
				<?php
